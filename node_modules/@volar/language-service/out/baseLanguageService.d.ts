...
export declare function createLanguageService(ctx: LanguageServiceOptions, documentRegistry?: ts.DocumentRegistry): {
    ...
    prepareRename: (uri: string, position: vscode.Position, token?: vscode.CancellationToken) => Promise<NonNullable<vscode.Range | vscode.ResponseError<void> | null | undefined> | undefined>;
    ...
    doDocumentLinkResolve: (item: vscode.CodeLens, token?: vscode.CancellationToken) => Promise<vscode.CodeLens>;
...
declare function createLanguageServiceBase(context: LanguageServicePluginContext): {
    triggerCharacters: string[];
    autoFormatTriggerCharacters: string[];
    signatureHelpTriggerCharacters: string[];
    signatureHelpRetriggerCharacters: string[];
